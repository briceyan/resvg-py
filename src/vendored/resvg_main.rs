...
pub(crate) fn process(env_args: Vec<OsString>) -> Result<(), String> {
...
fn parse_args(env_args: Vec<OsString>) -> Result<Args, String> {
    let args = collect_args(env_args).map_err(|e| e.to_string())?;
